    ...
    return (
        <section className='bg-home-bg-1 pt-10 md:pt-11.25 lg:pt-12.5 pb-10 md:pb-11.25 lg:pb-12.5 group/section'>
            <div className='container md:flex justify-between md:items-center gap-4 mb-10' ref={containerRef}>
                ...
                <Link href={"/shop-2"} className='text-gray-1-foreground lg:text-xl text-lg border-b border-b-primary mt-2.5 md:mt-0 inline-block hover:border-b-primary hover:text-secondary-foreground duration-500'>View All Collections</Link>
            </div>
