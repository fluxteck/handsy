...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm lg:text-base leading-normal font-medium rounded-full transition-all duration-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none lg:[&_svg]:size-auto [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: "px-6 py-2.5 lg:px-8 lg:py-3",
